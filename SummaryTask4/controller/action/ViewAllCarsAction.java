...
public class ViewAllCarsAction implements Action {
	private static final Logger LOGGER = LoggerFactory.getLogger(ViewAllCarsAction.class);

	/**
	 * This method privides the ability to view all cars.
	 */
	@Override
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		LOGGER.info("View all cars action");
