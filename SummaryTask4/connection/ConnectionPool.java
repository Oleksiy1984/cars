...
public class ConnectionPool {
	...
	public Connection getConnection() {
		try {
			...
			LOGGER.info("Get Connection. Free connections " + freeConnections.size());
	...
	private class PooledConnection implements Connection {
		...
		public synchronized void close() throws SQLException {
			...
			semaphore.release();
			LOGGER.info("Connection was closed. Free connections " + freeConnections.size());
		}
		...
		public void setAutoCommit(boolean autoCommit) throws SQLException {
			...
			LOGGER.info("connection.setAutoCommit to " +autoCommit+". Free connections " + freeConnections.size());
		}
